...
export const services = [
  {
    ...
    description:
      'Simulate real-world attacks to identify and remediate vulnerabilities before attackers do.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Proactively search for hidden threats within your network using cutting-edge intelligence.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Rapidly respond to and recover from security incidents to minimize damage and downtime.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Our security operations center (SOC) becomes an extension of your team, 24/7.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Get executive-level security leadership and strategic guidance without the full-time cost.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Secure your AWS, Azure, and GCP environments against misconfigurations and threats.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Discover and monitor all your internet-facing assets to eliminate unknown risks.',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Detect and takedown phishing sites, fake social media profiles, and brand impersonations.',
    benefits: [
