  ...
  return (
    <div className="text-center">
      ...
      <p className="mx-auto mt-4 max-w-3xl text-lg text-muted-foreground">
        We offer a full spectrum of services to identify vulnerabilities, hunt
        for threats, and respond to incidents with speed and precision.
      </p>
        ...
        {featuredServices.map((service) => {
          ...
          return (
            <Link
              href="/services"
              key={service.title}
              className="group rounded-lg border bg-card p-4 transition-all duration-300 hover:bg-accent/20 hover:shadow-lg hover:shadow-accent/10"
            >
